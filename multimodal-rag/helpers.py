...
def demo_vector_visualization():
    ...
    def plot_vectors(arr_in, text_inputs):
        ...
        fig.update_layout(
            title="Vector Embeddings: Similar Concepts == Closer",
...
def demo_multimodal_rag(client):
    ...
    prompt = GenerativeParameters.grouped_task(
        prompt="What does this say about value generated by AI? Provide a detailed, rich analysis based on the images.",
